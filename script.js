  ...
  function renderHero() {
    ...
    container.innerHTML = `
        ...
        <div class="hero-socials">
            ...
            <!-- Blogs – document icon (reliable) -->
            <a href="https://dev.to/anamikaghosh18" target="_blank" rel="noopener" class="social-box">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#FF5722">
    ...
    document.querySelectorAll(".fchip").forEach((chip) => {
      chip.addEventListener("click", () => {
        ...
        document.querySelectorAll(".proj-entry").forEach((entry) => {
          const show = f === "all" || entry.dataset.cat === f;
          entry.hidden = !show;
        });
      });
    });
  ...
  function renderBlogs() {
    ...
    function fetchArticles(retry = false) {
      fetch(`https://dev.to/api/articles?username=${username}`)
        ...
        .then((articles) => {
          console.log("API returned:", articles);
